...
point = {
    ...
    活动导航0 = "250|190|FAFB47,659|185|A3A838,1247|185|1E2222,1506|493|3E483F,1033|741|3B4D4F,1269|1023|324344",
    活动导航1 = "1522|690|FEFEFE,1710|744|AEB72B",
  ...
  活动商店列表 = {
    ...
    -- 水月 点击水月副本点击进入主题后,当前页面的水月_常规行动选中与不选中的两个状态色点
    ...
    傀影 = "33|140|000000",
    水月首页 = "1511|80|90A7BF,1548|90|ACC4E5,1520|107|849DBE",
    选中水月副本 = "100|600|000000",
    水月副本选中标识="64|435|DFE6E6,77|435|040303,88|437|DFE6E6",
    ...
    -- 第一层作战后选择走的路径,关卡图片出的箭头的位置
    第一层从下方来 = "1387|573|FFFFFF",
    第一层上一个 = { 613, 346 },
    --指迷雾歧途选择关卡界面一个个可点击的关卡图片
    第一层不期而遇1列表 = {
